...
ENGINEERING_DATA_SYSTEM = (
    ...
    "- A VALVE AND FITTING SURVEY section, already reconciled across multiple drawing crops, "
    "cross-checked against the instrument tag list, and already resolved to ONE type per item "
    "even where readings originally disagreed\n\n"
    "RULES:\n"
    ...
    "already been deduplicated, cross-checked, and resolved to a single type per item -- "
    "report exactly what's given. Do NOT reintroduce hedging language of your own (never "
    "write 'X or Y', 'unresolved', 'possibly', or similar) -- report the single type given.\n"
