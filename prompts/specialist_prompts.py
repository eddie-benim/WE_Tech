...
ENGINEERING_DATA_SYSTEM = (
    ...
    "correct them -- if the source says DB9, report DB9, not 089.\n"
    ...
    "- CRITICAL: an item identified by an explicit alphanumeric instrument tag (e.g. PSE-1682) "
    "is a different physical device from an item identified only by a bare BOM reference "
    "number (e.g. 401), even if they share a type (e.g. both rupture discs) and sit in the "
...
LINE_LIST_SYSTEM = (
    ...
    "those specs as your source -- do not substitute or normalise characters. If the spec reads DB9,\n"
    "report DB9. If it reads 089, report 089. Report exactly what was read. For any spec drawn from\n"
